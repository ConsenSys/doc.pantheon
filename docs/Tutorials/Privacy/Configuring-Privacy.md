...
!!! note
    In a paid gas network, [`--privacy-marker-transaction-signing-key-file`](../../Reference/Pantheon-CLI/Pantheon-CLI-Syntax.md#privacy-marker-transaction-signing-key-file) must be specified to sign [Private Marker Transactions](../../Concepts/Privacy/Private-Transaction-Processing.md) using the supplied private key.  
