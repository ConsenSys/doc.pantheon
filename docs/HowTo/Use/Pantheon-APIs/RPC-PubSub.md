...
Use the `logs` parameter with `eth_subscribe` to be notified of [logs](../../../Explanation/Events-and-Logs.md) included in new blocks. You can 
...
Logs subscriptions have an filter object parameter with the following fields:
  ...
  - `topics` - (optional) Returns only logs that match the [specified topics](../../../Explanation/Events-and-Logs.md#topic-filters).
