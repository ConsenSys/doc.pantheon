...
2. Start the bootnode, specifying:
    ...
    * No arguments for the [`--bootnodes` option](../../Reference/Pantheon-CLI/Pantheon-CLI-Syntax.md#bootnodes) because this is your bootnode.
...
To specify this bootnode for another node, specify the [enode URL](../../Explanation/Node-Keys.md#enode-url) using the [`--bootnodes`](../../Reference/Pantheon-CLI/Pantheon-CLI-Syntax.md#bootnodes) 
option.

!!! info
    The default host and port for P2P peer discovery is `127.0.0.1:30303`.
    Use the [`--p2p-host`](../../Reference/Pantheon-CLI/Pantheon-CLI-Syntax.md#p2p-host) and
    [`--p2p-port`](../../Reference/Pantheon-CLI/Pantheon-CLI-Syntax.md#p2p-port) option to specify a host and port. 
