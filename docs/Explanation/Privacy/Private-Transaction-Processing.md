...
The Privacy Marker Transaction is signed with the [Ethereum node private key](../../Explanation/Node-Keys.md#node-private-key).
...
The signed transaction includes transaction attributes that are specific to private transactions: 
    ...
    * `restriction` specifies the transaction is of type [_restricted_](../../Explanation/Privacy/Privacy-Overview.md#private-transactions)
...
1. The Private Transaction Handler creates a [Privacy Marker Transaction](../../Explanation/Privacy/Privacy-Overview.md#privacy-concepts) for the private 
